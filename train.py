...
def train(datasets, labels ,roar, judge):
    ...
    for curr_fold in range(fold):
        ...
        for epoch in range(training_epochs):
            ...
            PATH='./param/model_{}_{}.pth'.format(roar,judge)
            torch.save(model.state_dict(),PATH)
        total_train_acc.append(train_acc)
        total_train_loss.append(train_loss)
        total_test_acc.append(test_acc)
        total_test_loss.append(test_loss)
    with open("./data/train_loss_{}_{}.pickle".format(roar,judge),mode="wb") as f:
        pickle.dump(total_train_loss,f)
    with open("./data/test_loss_{}_{}.pickle".format(roar,judge),mode="wb") as f:
        pickle.dump(total_test_loss,f)
    with open("./data/train_acc_{}_{}.pickle".format(roar,judge),mode="wb") as f:
        pickle.dump(total_train_acc,f)
    with open("./data/test_acc_{}_{}.pickle".format(roar,judge),mode="wb") as f:
